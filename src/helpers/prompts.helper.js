...
You are a friendly AI assistant. The user just said: "${userPrompt}"
Respond with a short, engaging markdown message to acknowledge their request and let them know you are working on it.
